...
BikerCocaine = {
    ...
    Style = {
        none = "",
        basic = {"set_up", "equipment_upgrade", "coke_press_upgrade", "production_upgrade", "table_equipment_upgrade"},
    ...
    Security = {
        none = "security_high", basic = "security_high", upgrade = "security_high",
